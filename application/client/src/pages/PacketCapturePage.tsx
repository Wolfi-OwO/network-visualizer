...
import { packets as packetsApi } from '../lib/api'
import FilterBar from '../components/PacketCapture/FilterBar'
import ProtocolFilter, { PROTOCOLS } from '../components/PacketCapture/ProtocolFilter'
import PacketList from '../components/PacketCapture/PacketList'
import PacketDetail from '../components/PacketCapture/PacketDetail'
import HexDump from '../components/PacketCapture/HexDump'
import StatsPanel from '../components/PacketCapture/StatsPanel'
...
export default function PacketCapturePage() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const { data } = await packetsApi.stats()
      setStats(data)
    } catch { /* ignore */ }
  }, [])

  const startCapture = useCallback(async () => {
    await packetsApi.start()
    setCapturing(true)
    setAutoScroll(true)
