...
export const DEVICE_META: Record<NodeType, DeviceMeta> = {
  ...
  router: {
    ...
    bg: '#0d2040',
    role: 'l3',
    hint: 'Layer-3 routing',
    canHostServices: false,
    dhcpClient: false,
  },
  l3switch: {
    label: 'L3 Switch',
  ...
  load_balancer: {
    ...
    bg: '#1a0d2a',
    role: 'delivery',
    hint: 'Distributes traffic across a pool',
    canHostServices: true,
    dhcpClient: false,
  },
  proxy: {
    label: 'Reverse Proxy',
    ...
    bg: '#1a0d2a',
    role: 'delivery',
    hint: 'Terminates & forwards to backends',
    canHostServices: true,
    dhcpClient: false,
  },
  api_gateway: {
...
export const PALETTE_CATEGORIES: { category: string; types: NodeType[] }[] = [
  ...
  { category: 'Traffic & Delivery', types: ['load_balancer', 'proxy', 'api_gateway'] },
  {
    ...
    types: ['server', 'dns', 'dhcp', 'mailserver', 'fileserver', 'database', 'virtualhost'],
  },
