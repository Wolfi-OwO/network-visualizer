...
The code shows _what_ NetViz does. Git shows _when_ it changed. Neither shows
...
a decision is later reversed, that reversal is a _new_ ADR that supersedes the old
...
- Deliberately _not_ doing the obvious thing — those are the most valuable ADRs,
